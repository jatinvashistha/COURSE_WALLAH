        ...
        <ModalContent>
         ...
         <Input 
            ...
            accept='video/mp4'
             ...
             <Button
             isLoading={loading}
             w={'full'} colorScheme='purple' type="submit">
                Upload
             </Button>
              </VStack>
...
function VideoCard({num,title,description,lectureId,courseId,deleteButtonHandler,loading}){

    return(
        <Stack direction={['column','row']} my={'8'}
        borderRadius={"lg"} boxShadow={'0 0 10px rgba(107,70,193,0.5)'} justifyContent={['flex-start','space-between']} p={['4','8']}
        >
            <Box>
                <Heading size={'sm'}
                children={`#${num} ${title} `}
