...
const logoutHandler = ()=>{
  ...
  return (
   ...
   <ColorModeSwitcher/>
  <Button onClick={onOpen} colorScheme={"yellow"} width="12" height={'12'} rounded="full" zIndex={"overlay"} position={"fixed"} top="4" left="4">
    <RiMenu5Fill />
  </Button>
...
<DrawerHeader borderBottomWidth={"1px"} >Course Wallah</DrawerHeader>
